    ...
    <div class="main-division__top-right-bar">
        <div class="main-division__top-main-item" id="professional">
            ...
            <div class="main-division__top-title-icon">
                ...
                >
                <path
                    d="M0 16.12H16V0.12L0 0.12L0 16.12Z"
                    fill="url(#pattern0)"
                />
                <defs>
                    <pattern
