...
<div class="position__card-item">
    <a href="<?= get_the_permalink($vacancy_item_id); ?>" class="position__info-link">
        посмотреть вакансию
    ...
    <div class="position__job-title-container">
        <a href="<?= get_the_permalink($vacancy_item_id); ?>" class="position__job-title"><?= get_the_title($vacancy_item_id); ?></a>
    ...
    <div class="position__payment-container">
        ...
        от
        <span class="position__payment-value"><?= number_format( get_field( 'money_from', $vacancy_item_id ), 0, ',', ' '); ?></span>
    ...
    <div class="position__location-container">
        <? $cur_terms = get_the_terms( $vacancy_item_id, 'town' );
