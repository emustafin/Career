<?php
$specialization_terms = get_the_terms( $vacancy_item_id, $_modificator.'specialization' );
...
<div class="profession__job-item" data-vacancy_id="<?php echo $vacancy_item_id; ?>">
        ...
        <div class="profession__bread-crumbs">
            <a href="#" class="profession__crumb">
                ...
                <svg width="12" height="8" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9.4136 3.55008L7.1818 1.31828L7.8182 0.681885L11.1364 4.00008L7.8182 7.31828L7.1818 6.68189L9.4136 4.45008H0.75V3.55008H9.4136Z" fill="rgba(0, 0, 0, 0.5)"/>
                </svg>
            </a>
            <a href="<?php echo get_term_link( $first_specialization->term_id, $_modificator.'specialization'); ?>" class="profession__crumb">
                <?php echo $first_specialization->name; ?>
                <!-- <svg
                    width="12"
                    height="8"
                    viewBox="0 0 12 8"
    ...
    <div class="profession__job-price-container">
        ...
        <?php if( get_field( 'can_without_experience', $vacancy_item_id ) ){ ?>
    ...
    <div class="profession__location-container">
        <?php
        $city_terms = get_the_terms( $vacancy_item_id, $_modificator.'city' );
        if( is_array( $city_terms ) ){
            foreach( $city_terms as $city_term ){
                ?>
                <p class="profession__location-city"><?php echo $city_term->name; ?></p>
                <?php
            }

            $metro_terms = get_the_terms( $vacancy_item_id, $_modificator.'metro' );
            if( is_array( $metro_terms ) ){
                foreach( $metro_terms as $metro_term ){
                    echo $metro_term->name;
                }
            }
        }
        ?>
