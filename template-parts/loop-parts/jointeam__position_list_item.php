<a href="/<?php echo $main_search_link; ?>/?search=<?php echo $vacancy_search_content['title']; ?>" class="retail__position-list-item" data-vacancy_id="<?php echo $vacancy_search_content['title']; ?>">
    <div class="retail__position-item-position">
        <p class="retail__position-item-position-title">
            <?php echo $vacancy_search_content['title']; ?>
        </p>
    </div>

    <div class="retail__position-item-description">
        <p class="retail__position-description-text">
            <?php echo $vacancy_search_content['context']; ?>
        </p>
    ...
    <!-- <a href="/<?php echo $main_search_link; ?>/?search=<?php echo $vacancy_search_content['title']; ?>" class="retail__position-item-button">
