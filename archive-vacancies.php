    ...
    <div class="page-container">
        ...
        <div class="listing-top__filters-wrapper">
            <div class="listing-top__filter-item">
                ...
                <input name="tags-outside" class="tagify--outside listing-top__profession-filter" placeholder="Выбери профессию" value="<?php echo ( isset($_GET['s']) && $_GET['s'] != '' ? $_GET['s'] : '' ); ?>"/>
            ...
            <div class="listing-top__filter-item">
                ...
                <div class="profession__filter-item-select">
                    ...
                    <input class="selectMode listing__specialization-select" name="tags-select-mode" placeholder="Выбери специализацию" value="" />
            ...
            <div class="listing-top__filter-item">
                ...
                <div class="profession__filter-item-select">
                    ...
                    <input class="selectMode listing__level-select" name="tags-select-mode" placeholder="Выбери уровень" />
                ...
                <div class="listing__filter-item-border-bottom">
                    <label class="profession__filter-checbox-listing">
                        ...
                        <span class="profession__filter-checbox-value">
                            ...
                            <path d="M12.5 5L6.5 11L3.5 8" stroke="black" stroke-width="1.2" />
                            </svg>
                        </span>
                    </label>
                </div>
            ...
            <div class="listing-top__filter-item">
                ...
                <div class="profession__filter-item-select">
                    ...
                    <input class="selectMode listing__city-select" name="tags-select-mode" placeholder="Выбери город" />
                    <div class="listing__filter-item-select-arrow">
                        <svg class="listing__filter-item-select-arrow-image" width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg" >
                            <path d="M5.58286 7.56905V0.925293H4.38286V7.53389L1.4247 4.57574L0.576172 5.42426L4.22262 9.07071C4.65219 9.50029 5.34868 9.50029 5.77825 9.07071L9.4247 5.42426L8.57617 4.57574L5.58286 7.56905Z" fill="black" />
                        </svg>
                    ...
                    <div class="banner-S">
                        <div class="banner-S__content">
                            ...
                            <div class="banner-S__image-container">
                                <img class="banner-S__image" src="<?php echo THEME_URL; ?>/assets/images/listing/Banner-S/banner-s-image.png" alt="Banner" />
                            </div>
                            <div class="banner-S__title-container">
                                <h2 class="banner-S__title">
                                    ...
                                    посмотреть вакансии
                                    <svg class="banner-S__link-arrow" width="12" height="8" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg" >
                                        <path d="M9.4136 3.55001L7.1818 1.3182L7.8182 0.681808L11.1364 4.00001L7.8182 7.3182L7.1818 6.68181L9.4136 4.45001H0.75V3.55001H9.4136Z" fill="black" />
                                    </svg>
                                    </a>
                                </h2>
                    ...
                    <div class="banner-l">
                        <div class="banner-l__content">
                            ...
                            <div class="banner-l__header-background">
                                <svg class="banner-l__header-background-image" width="921" height="284" viewBox="0 0 921 284" fill="none" xmlns="http://www.w3.org/2000/svg" >
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M686.378 1.37198H546.555C510.972 1.37198 482.127 30.242 482.127 65.8551C482.127 101.468 510.972 130.338 546.555 130.338H686.378C721.961 130.338 750.807 101.468 750.807 65.8551C750.807 30.242 721.961 1.37198 686.378 1.37198ZM546.555 0C510.215 0 480.756 29.4843 480.756 65.8551C480.756 102.226 510.215 131.71 546.555 131.71H686.378C722.718 131.71 752.178 102.226 752.178 65.8551C752.178 29.4843 722.718 0 686.378 0H546.555Z" fill="#E31235" />
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M632.916 65.8551C632.916 95.4063 656.851 119.362 686.378 119.362C715.904 119.362 739.839 95.4063 739.839 65.8551C739.839 36.3038 715.904 12.3478 686.378 12.3478C656.851 12.3478 632.916 36.3038 632.916 65.8551ZM686.378 10.9758C656.094 10.9758 631.545 35.5461 631.545 65.8551C631.545 96.164 656.094 120.734 686.378 120.734C716.661 120.734 741.21 96.164 741.21 65.8551C741.21 35.5461 716.661 10.9758 686.378 10.9758Z" fill="#E31235" />
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M205.622 1.37198H65.7992C30.2164 1.37198 1.37082 30.242 1.37082 65.8551C1.37082 101.468 30.2164 130.338 65.7992 130.338H205.622C241.205 130.338 270.051 101.468 270.051 65.8551C270.051 30.242 241.205 1.37198 205.622 1.37198ZM65.7992 0C29.4593 0 0 29.4843 0 65.8551C0 102.226 29.4593 131.71 65.7992 131.71H205.622C241.962 131.71 271.422 102.226 271.422 65.8551C271.422 29.4843 241.962 0 205.622 0H65.7992Z" fill="#76BC21" />
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M152.16 65.8551C152.16 95.4063 176.096 119.362 205.622 119.362C235.148 119.362 259.084 95.4063 259.084 65.8551C259.084 36.3038 235.148 12.3478 205.622 12.3478C176.096 12.3478 152.16 36.3038 152.16 65.8551ZM205.622 10.9758C175.338 10.9758 150.789 35.5461 150.789 65.8551C150.789 96.164 175.338 120.734 205.622 120.734C235.905 120.734 260.454 96.164 260.454 65.8551C260.454 35.5461 235.905 10.9758 205.622 10.9758Z" fill="#76BC21" />
                                    ...
                                    <path d="M936.953 67.0261H774.109V65.6541H936.953L927.156 55.8493L928.125 54.8792L939.577 66.3401L928.125 77.801L927.156 76.8309L936.953 67.0261Z" fill="#E31235" />
                                    <path d="M456.199 67.0261H293.355V65.6541H456.199L446.402 55.8493L447.372 54.8792L458.823 66.3401L447.372 77.801L446.402 76.8309L456.199 67.0261Z" fill="#76BC21" />
                            ...
                            <a href="#" class="banner-l__header-link">
                                заполнить анкету
                                <svg class="banner-l__header-link-arrow" width="12" height="8" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg" >
                                    <path d="M9.4136 3.55001L7.1818 1.3182L7.8182 0.681808L11.1364 4.00001L7.8182 7.3182L7.1818 6.68181L9.4136 4.45001H0.75V3.55001H9.4136Z" fill="black" />
                                </svg>
                            </a>
                        </div>
                ...
                <?php if( $i == 7 ): ?>
                    ...
                    <div class="position-subscribe">
                        ...
                        <div class="position-subscribe__content">
                            ...
                            <input class="position-subscribe__input" type="text" value="Электронная почта" />
...
<script>
    ...
    var max_num_pages = parseInt('<?php echo json_encode($wp_query->max_num_pages); ?>');
</script>
<!-- //Button Show-more -->
            ...
            if ( $actually_news->have_posts() ) {
                ...
                <a href="<?php echo $url_from_habr; ?>" target="_blank" class="vacancy__news-item swiper-slide">
                    <div class="vacancy__news-item-image-block loading">
                        <img class="vacancy__news-image" data-src="<?php echo $thumbnail_url; ?>" src="<?php echo THEME_URL; ?>/assets/images/Lazy-loading/1x1.png" alt="News" title="Новости" width="500" height="280" />
                    </div>
