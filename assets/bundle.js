...
/***/ "./js/components/itHubPage/scroll.js":
/*!*******************************************!*\
  !*** ./js/components/itHubPage/scroll.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"ScrollTo\": () => (/* binding */ ScrollTo)\n/* harmony export */ });\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n/*\r\n* el - вызывает событие (DOM узел) | срока для поисмка DOM узела\r\n* scrollTo- скролит до данного эллемента (DOM узел) | срока для поисмка DOM узела\r\n* parmScroll - bool значение\r\n*   false - прокрутка до нижней границы\r\n*   true - прокрутка верхней границы (дефолтное значение)\r\n* */\nvar ScrollTo = /*#__PURE__*/function () {\n  function ScrollTo(el, scrollTo) {\n    var parmScroll = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;\n\n    _classCallCheck(this, ScrollTo);\n\n    this.el = el;\n    this.scrollTo = scrollTo;\n    this.paraScroll = parmScroll;\n    this.init();\n    this.el.onclick = this.handleClick.bind(this);\n  }\n\n  _createClass(ScrollTo, [{\n    key: \"init\",\n    value: function init() {\n      if (typeof this.el == \"string\") this.el = document.querySelector(\"\".concat(this.el));\n      if (typeof this.scrollTo == \"string\") this.scrollTo = document.querySelector(\"\".concat(this.scrollTo));\n      if (this.el == null || undefined || this.scrollTo == null || undefined) return console.error(\"Присутсвуют не все входные классы у эллемента\");\n    }\n  }, {\n    key: \"handleClick\",\n    value: function handleClick() {\n      var yOffset = -10;\n      var y = this.scrollTo.getBoundingClientRect().top + window.pageYOffset + yOffset;\n      window.scrollTo({\n        top: y,\n        behavior: 'smooth'\n      });\n    }\n  }]);\n\n  return ScrollTo;\n}();\n\n//# sourceURL=webpack:///./js/components/itHubPage/scroll.js?");
