...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"ItHubPageCareerUpgradeBlock\": () => (/* binding */ ItHubPageCareerUpgradeBlock)\n/* harmony export */ });\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar ItHubPageCareerUpgradeBlock = /*#__PURE__*/function () {\n  function ItHubPageCareerUpgradeBlock(className) {\n    var _this = this;\n\n    _classCallCheck(this, ItHubPageCareerUpgradeBlock);\n\n    this.el = document.querySelector(className);\n    if (this.el == null || this.el == undefined) return;\n    this.slidesPrev = Array.from(this.el.querySelectorAll('.upgrade__slider-prev-image'));\n    this.slidesMain = Array.from(this.el.querySelectorAll('.upgrade__middle-image-item'));\n    this.slidesNext = Array.from(this.el.querySelectorAll('.upgrade__slider-next-item'));\n    this.prevSliderRow = this.el.querySelector('.upgrade__slider-prev-image-row');\n    this.mainSliderRow = this.el.querySelector('.upgrade__middle-image-row');\n    this.nextSliderRow = this.el.querySelector('.upgrade__slider-next-row');\n    this.currentSlideNumber = 1;\n    this.currentSlideRowPosition = 0;\n    this.prevSlider = new Swiper('.swiperUpgrage', {// loop: true,\n    });\n    this.mainSlider = new Swiper('.mainSlider', {// loop: true,\n    });\n    this.nextSlider = new Swiper('.nextSlider', {// loop: true,\n    });\n    this.mainSlider.on('slideChange', function () {\n      _this.nextSlider.slideToLoop(_this.mainSlider.realIndex);\n\n      _this.prevSlider.slideToLoop(_this.mainSlider.realIndex);\n    });\n    this.prevSlider.on('slideChange', function () {\n      _this.nextSlider.slideToLoop(_this.prevSlider.realIndex);\n\n      _this.mainSlider.slideToLoop(_this.prevSlider.realIndex);\n    });\n    this.nextSlider.on('slideChange', function () {\n      _this.prevSlider.slideToLoop(_this.nextSlider.realIndex);\n\n      _this.mainSlider.slideToLoop(_this.nextSlider.realIndex);\n    });\n    this.prevSlider_eldorado = new Swiper('.swiperUpgrage_eldorado', {// loop: true,\n    });\n    this.mainSlider_eldorado = new Swiper('.mainSlider_eldorado', {// loop: true,\n    });\n    this.nextSlider_eldorado = new Swiper('.nextSlider_eldorado', {// loop: true,\n    });\n    this.mainSlider_eldorado.on('slideChange', function () {\n      _this.nextSlider_eldorado.slideToLoop(_this.mainSlider_eldorado.realIndex);\n\n      _this.prevSlider_eldorado.slideToLoop(_this.mainSlider_eldorado.realIndex);\n    });\n    this.prevSlider_eldorado.on('slideChange', function () {\n      _this.nextSlider_eldorado.slideToLoop(_this.prevSlider_eldorado.realIndex);\n\n      _this.mainSlider_eldorado.slideToLoop(_this.prevSlider_eldorado.realIndex);\n    });\n    this.nextSlider.on('slideChange', function () {\n      _this.prevSlider_eldorado.slideToLoop(_this.nextSlider_eldorado.realIndex);\n\n      _this.mainSlider_eldorado.slideToLoop(_this.nextSlider_eldorado.realIndex);\n    });\n    this.init();\n  }\n\n  _createClass(ItHubPageCareerUpgradeBlock, [{\n    key: \"init\",\n    value: function init() {\n      this.el.addEventListener('click', sliderClickHandler.bind(this));\n    }\n  }]);\n\n  return ItHubPageCareerUpgradeBlock;\n}();\n\nfunction sliderClickHandler(event) {\n  if (event.target.classList.contains('upgrade__arrow-prev')) {\n    this.mainSlider.slidePrev();\n  }\n\n  if (event.target.classList.contains('upgrade__slider-next-arrow')) {\n    this.mainSlider.slideNext();\n  }\n}\n\n//# sourceURL=webpack:///./js/components/itHubPage/itHubCareerUpgrade.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"headerItPage\": () => (/* binding */ headerItPage),\n/* harmony export */   \"vacancyDirectLinkMainContent\": () => (/* binding */ vacancyDirectLinkMainContent),\n/* harmony export */   \"profession\": () => (/* binding */ profession),\n/* harmony export */   \"retail__position\": () => (/* binding */ retail__position),\n/* harmony export */   \"vacancyDirectLinkHeader\": () => (/* binding */ vacancyDirectLinkHeader),\n/* harmony export */   \"smothScrollingToBlock\": () => (/* binding */ smothScrollingToBlock),\n/* harmony export */   \"swichersAnimation\": () => (/* binding */ swichersAnimation)\n/* harmony export */ });\n/* harmony import */ var _components_itHubPage_itHubVacancyBlock__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/itHubPage/itHubVacancyBlock */ \"./js/components/itHubPage/itHubVacancyBlock.js\");\n/* harmony import */ var _components_itHubPage_itHubPageAdvantagesBlock__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/itHubPage/itHubPageAdvantagesBlock */ \"./js/components/itHubPage/itHubPageAdvantagesBlock.js\");\n/* harmony import */ var _components_itHubPage_itHubCareerUpgrade__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/itHubPage/itHubCareerUpgrade */ \"./js/components/itHubPage/itHubCareerUpgrade.js\");\n/* harmony import */ var _components_itHubPage_itHubVideoPlayerBlock__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/itHubPage/itHubVideoPlayerBlock */ \"./js/components/itHubPage/itHubVideoPlayerBlock.js\");\n/* harmony import */ var _components_itHubPage_itHubRunningLine__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/itHubPage/itHubRunningLine */ \"./js/components/itHubPage/itHubRunningLine.js\");\n/* harmony import */ var _components_itHubPage_itHubGoalsBlock__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/itHubPage/itHubGoalsBlock */ \"./js/components/itHubPage/itHubGoalsBlock.js\");\n/* harmony import */ var _components_itHubPage_itHubPagecustomSelectInVacancy__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/itHubPage/itHubPagecustomSelectInVacancy */ \"./js/components/itHubPage/itHubPagecustomSelectInVacancy.js\");\n/* harmony import */ var _components_itHubPage_itHubInternship__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/itHubPage/itHubInternship */ \"./js/components/itHubPage/itHubInternship.js\");\n/* harmony import */ var _components_itHubPage_itHubDirectionBlock__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/itHubPage/itHubDirectionBlock */ \"./js/components/itHubPage/itHubDirectionBlock.js\");\n/* harmony import */ var _components_itHubPage_itHubVacancyContainerInProfessionBlock__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/itHubPage/itHubVacancyContainerInProfessionBlock */ \"./js/components/itHubPage/itHubVacancyContainerInProfessionBlock.js\");\n/* harmony import */ var _components_itHubPage_form__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/itHubPage/form */ \"./js/components/itHubPage/form.js\");\n/* harmony import */ var _components_itHubPage_vacancyListingPage_listingVacancyPage__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/itHubPage/vacancyListingPage/listingVacancyPage */ \"./js/components/itHubPage/vacancyListingPage/listingVacancyPage.js\");\n/* harmony import */ var _components_itHubPage_vacancyListingPage_listingVacancyFiltersBlock__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/itHubPage/vacancyListingPage/listingVacancyFiltersBlock */ \"./js/components/itHubPage/vacancyListingPage/listingVacancyFiltersBlock.js\");\n/* harmony import */ var _components_itHubPage_vacancyListingPage_listingVacansiesPopup__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./components/itHubPage/vacancyListingPage/listingVacansiesPopup */ \"./js/components/itHubPage/vacancyListingPage/listingVacansiesPopup.js\");\n/* harmony import */ var _components_itHubPage_vacancyListingPage_listingPageMapBlock__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/itHubPage/vacancyListingPage/listingPageMapBlock */ \"./js/components/itHubPage/vacancyListingPage/listingPageMapBlock.js\");\n/* harmony import */ var _components_itHubPage_vacancyListingPage_listingFilters__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./components/itHubPage/vacancyListingPage/listingFilters */ \"./js/components/itHubPage/vacancyListingPage/listingFilters.js\");\n/* harmony import */ var _components_itHubPage_header__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./components/itHubPage/header */ \"./js/components/itHubPage/header.js\");\n/* harmony import */ var _components_itHubPage_footer__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./components/itHubPage/footer */ \"./js/components/itHubPage/footer.js\");\n/* harmony import */ var _components_itHubPage_vacancyDirectLinkPage_directLinkSideBar__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./components/itHubPage/vacancyDirectLinkPage/directLinkSideBar */ \"./js/components/itHubPage/vacancyDirectLinkPage/directLinkSideBar.js\");\n/* harmony import */ var _components_itHubPage_vacancyDirectLinkPage_vacancyDirectLinkMainContent__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./components/itHubPage/vacancyDirectLinkPage/vacancyDirectLinkMainContent */ \"./js/components/itHubPage/vacancyDirectLinkPage/vacancyDirectLinkMainContent.js\");\n/* harmony import */ var _components_itHubPage_vacancyDirectLinkPage_vacancyDirectLinkNews__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./components/itHubPage/vacancyDirectLinkPage/vacancyDirectLinkNews */ \"./js/components/itHubPage/vacancyDirectLinkPage/vacancyDirectLinkNews.js\");\n/* harmony import */ var _components_animation__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./components/animation */ \"./js/components/animation.js\");\n/* harmony import */ var _components_retail_createRetailFuture__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./components/retail/createRetailFuture */ \"./js/components/retail/createRetailFuture.js\");\n/* harmony import */ var _components_retail_retailMissionBlock__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./components/retail/retailMissionBlock */ \"./js/components/retail/retailMissionBlock.js\");\n/* harmony import */ var _components_retail_retailBrandsBlock__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./components/retail/retailBrandsBlock */ \"./js/components/retail/retailBrandsBlock.js\");\n/* harmony import */ var _components_retail_retailPositionBlock__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./components/retail/retailPositionBlock */ \"./js/components/retail/retailPositionBlock.js\");\n/* harmony import */ var _components_retail_retailQuote__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./components/retail/retailQuote */ \"./js/components/retail/retailQuote.js\");\n/* harmony import */ var _components_retail_retailInternship__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./components/retail/retailInternship */ \"./js/components/retail/retailInternship.js\");\n/* harmony import */ var _components_retail_retailAdvantages__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./components/retail/retailAdvantages */ \"./js/components/retail/retailAdvantages.js\");\n/* harmony import */ var _components_retail_retailUpgrade__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./components/retail/retailUpgrade */ \"./js/components/retail/retailUpgrade.js\");\n/* harmony import */ var _components_retail_retailFooter__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./components/retail/retailFooter */ \"./js/components/retail/retailFooter.js\");\n/* harmony import */ var _components_servece_and_logistic_logisticFirstScreenBlock__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./components/servece-and-logistic/logisticFirstScreenBlock */ \"./js/components/servece-and-logistic/logisticFirstScreenBlock.js\");\n/* harmony import */ var _components_servece_and_logistic_logisticVacanciesBlock__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./components/servece-and-logistic/logisticVacanciesBlock */ \"./js/components/servece-and-logistic/logisticVacanciesBlock.js\");\n/* harmony import */ var _components_servece_and_logistic_logisticFlyout__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./components/servece-and-logistic/logisticFlyout */ \"./js/components/servece-and-logistic/logisticFlyout.js\");\n// Импорт классов страницы IT\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n //-----------------------------------------------------------\n// Вакансия по прямой ссылке. Разобраться с экспортами внутри компонентов cайд-бар и основной контент!!!!!!!!\n\n\n\n //----------------------------------------------------------\n//--------------------------------------------------\n// Печатная машинка в блоке IT-создавай будущее (Вынести в отдельный компонент)\n\n //-----------------------------------------------\n// Импорт классов страницы Розницы\n\n\n\n\n\n\n\n\n\n // Импорт классов со страницы \"Сервис и Логистика\"\n\n\n\n // Перенос изображений и шрифтов в Dist\n\n__webpack_require__(\"./images sync recursive \\\\.(png|jpg|svg|gif)$\");\n\n__webpack_require__(\"./fonts sync recursive \\\\.(ttf|woff|woff2)$\"); // Глобальные переменные\n//------------------------------------------------------------------------\n// Разобраться с экспортами!!!!!!!!!!!!!!!! Передать в компонент через функцию компонента (Функцию надо будет создать!!!)\n\n\nvar headerItPage = document.querySelector('.it-header');\nvar vacancyDirectLinkMainContent = document.querySelector('.direct-link__content');\nvar profession = document.querySelector('.profession');\nvar retail__position = document.querySelector('.retail__position');\nvar vacancyDirectLinkHeader = document.querySelector('.direct-link__header'); // -------------------------------------------------------------------------\n// Закомментированные переменные можно удалить:\n// const listingPage = document.querySelector('.listing');\n// const ourAdvantages = document.querySelector('.why-are-we');\n// const upgradeSection = document.querySelector('.upgrade');\n// const videoPlayerBlock = document.querySelector('.find');\n// const form = document.querySelector('.form');\n// const runningLine = document.querySelector('.find__title');\n// const goalBlock = document.querySelector('.goal');\n// const vacancyDirectLinkSideBar = document.querySelector(\n//   '.direct-link__side-bar'\n// );\n// const vacancyDirectLinkNews = document.querySelector(\n//   '.vacancy__news-block-desktop'\n// );\n// const professionCustomSelect = document.querySelector(\n//   '.profession__filter-wrapper'\n// );\n// const listingPageFilters = document.querySelector(\n//   '.listing-top__filters-wrapper'\n// );\n// const intern = document.querySelector('.intern');\n// const direction = document.querySelector('.direction');\n// const footerPage = document.querySelector('.footer');\n// const directLink = document.querySelector('.direct-link');\n// const listingVacansiesContainer = document.querySelector(\n//   '.position__card-wrapper'\n// );\n// const itPageVacancyContainer = document.querySelector(\n//   '.profession__job-wrapper'\n// );\n//---------------------------------------------------------------------------\n// Страница 404\n\nvar page404 = document.querySelector('.page-404'); //--------------------------------------------------\n// Проведен рефакторинг\n\nvar vacancyListingComponent = new _components_itHubPage_vacancyListingPage_listingVacancyPage__WEBPACK_IMPORTED_MODULE_11__.ListingVacancyPage('.listing');\nnew _components_itHubPage_vacancyListingPage_listingVacancyFiltersBlock__WEBPACK_IMPORTED_MODULE_12__.ListingVacancyFiltersBlock('.listing-top__filters-wrapper');\nnew _components_itHubPage_vacancyListingPage_listingVacansiesPopup__WEBPACK_IMPORTED_MODULE_13__.ListingVacansiesPagePopup('.position__card-wrapper');\nnew _components_itHubPage_vacancyListingPage_listingPageMapBlock__WEBPACK_IMPORTED_MODULE_14__.ListingVacancyMapBlock('.listing-metro__content-map', '.listing-metro__content-list', '.listing-top__filter-list-wrapper');\nnew _components_itHubPage_vacancyListingPage_listingFilters__WEBPACK_IMPORTED_MODULE_15__.ListingMapPageFilters('.listing-top__filters-wrapper-map');\nnew _components_itHubPage_itHubPageAdvantagesBlock__WEBPACK_IMPORTED_MODULE_1__.ItHubPageAdvantagesBlock('.why-are-we');\nnew _components_itHubPage_itHubCareerUpgrade__WEBPACK_IMPORTED_MODULE_2__.ItHubPageCareerUpgradeBlock('.upgrade');\nnew _components_itHubPage_itHubVideoPlayerBlock__WEBPACK_IMPORTED_MODULE_3__.ItHubVideoPlayerBlock('.find');\nnew _components_itHubPage_itHubRunningLine__WEBPACK_IMPORTED_MODULE_4__.ItHubRunningLineBlock('.find__title');\nvar itHubPageGoalBlock = new _components_itHubPage_itHubGoalsBlock__WEBPACK_IMPORTED_MODULE_5__.ItHubGoalsBlock('.goal');\nnew _components_itHubPage_itHubPagecustomSelectInVacancy__WEBPACK_IMPORTED_MODULE_6__.ItHubPageCustomSelectInProfessionBlock('.profession__filter-wrapper');\nnew _components_itHubPage_itHubInternship__WEBPACK_IMPORTED_MODULE_7__.ItHubInternshipBlock('.intern');\nvar itPageDirection = new _components_itHubPage_itHubDirectionBlock__WEBPACK_IMPORTED_MODULE_8__.ItHubDirectionBlock('.direction');\nnew _components_itHubPage_itHubVacancyContainerInProfessionBlock__WEBPACK_IMPORTED_MODULE_9__.ItHubVacanciesContainerInProfessionBlock('.profession__job-wrapper');\nnew _components_itHubPage_form__WEBPACK_IMPORTED_MODULE_10__.Form('.form');\nvar headerComponent = new _components_itHubPage_header__WEBPACK_IMPORTED_MODULE_16__.Header('.it-header');\nnew _components_itHubPage_footer__WEBPACK_IMPORTED_MODULE_17__.Footer('.footer');\nnew _components_itHubPage_vacancyDirectLinkPage_directLinkSideBar__WEBPACK_IMPORTED_MODULE_18__.VacancyDirecLinkSideBar('.direct-link__side-bar');\nnew _components_itHubPage_vacancyDirectLinkPage_vacancyDirectLinkNews__WEBPACK_IMPORTED_MODULE_20__.VacancyDirecLinkNewsBlock('.vacancy__news-block-desktop'); //--------------------------------------------------------\n// Не получилось изменить входной параметр (выдает ошибку - некорректный селектор)\n\nnew _components_itHubPage_vacancyDirectLinkPage_vacancyDirectLinkMainContent__WEBPACK_IMPORTED_MODULE_19__.VacancyDirecLinkMainContent(vacancyDirectLinkMainContent);\n\nif (null != profession) {\n  var _itHubPageVacancy = new _components_itHubPage_itHubVacancyBlock__WEBPACK_IMPORTED_MODULE_0__.ItHubVacancyBlock(profession);\n} else {\n  if (null != retail__position) {\n    var _itHubPageVacancy2 = new _components_itHubPage_itHubVacancyBlock__WEBPACK_IMPORTED_MODULE_0__.ItHubVacancyBlock(retail__position);\n  }\n} //-----------------------------------------------------------\n// Инициализация классов страницы Розницы\n\n\nvar retailCreateFuture = new _components_retail_createRetailFuture__WEBPACK_IMPORTED_MODULE_22__.CreateRetailFutureComponent('.retail__preview');\nvar retailMissionBlock = new _components_retail_retailMissionBlock__WEBPACK_IMPORTED_MODULE_23__.RetailMissionBlock('.retail__mission');\nvar retailBrandsBlock = new _components_retail_retailBrandsBlock__WEBPACK_IMPORTED_MODULE_24__.RetailBrandsBlock('.brands');\nvar retailPositionBlock = new _components_retail_retailPositionBlock__WEBPACK_IMPORTED_MODULE_25__.RetailPositionBlock('.retail__position');\nvar retailQuote = new _components_retail_retailQuote__WEBPACK_IMPORTED_MODULE_26__.RetailQuoteBlock('.retail__quote-container');\nvar retailInternshipBlock = new _components_retail_retailInternship__WEBPACK_IMPORTED_MODULE_27__.RetailInternshipBlock('.retail__internship');\nvar retailAdvantagesBlock = new _components_retail_retailAdvantages__WEBPACK_IMPORTED_MODULE_28__.RetailAdvantagesBlock('.retail__advantages');\nvar retailUpgradeBlock = new _components_retail_retailUpgrade__WEBPACK_IMPORTED_MODULE_29__.RetailUpgradeBlock('.upgrade');\nvar retailFooter = new _components_retail_retailFooter__WEBPACK_IMPORTED_MODULE_30__.RetailFooter('.retail__footer');\nretailCreateFuture.registerParameters(headerItPage, retailMissionBlock);\nretailMissionBlock.registerParameters(retailBrandsBlock, headerItPage);\nretailBrandsBlock.getAllBrandsTabs([{\n  name: 'mvideo',\n  elements: retailBrandsBlock.mvideoFromBrandsPage\n}, {\n  name: 'eldorado',\n  elements: retailBrandsBlock.eldoradoFromBrandsPage\n}, {\n  name: 'mvideo',\n  elements: retailPositionBlock.mvideoFromPositionPage\n}, {\n  name: 'eldorado',\n  elements: retailPositionBlock.eldoradoFromPositionPage\n}, {\n  name: 'mvideo',\n  elements: retailQuote.mvideoFromQuoteBlock\n}, {\n  name: 'eldorado',\n  elements: retailQuote.eldoradoFromQuoteBlock\n}, {\n  name: 'mvideo',\n  elements: retailInternshipBlock.mvideoFromInternshipPage\n}, {\n  name: 'eldorado',\n  elements: retailInternshipBlock.eldoradoFromInternshipPage\n}, {\n  name: 'mvideo',\n  elements: retailAdvantagesBlock.mvideoFromRetailAdvantages\n}, {\n  name: 'eldorado',\n  elements: retailAdvantagesBlock.eldoradoFromRetailAdvantages\n}, {\n  name: 'mvideo',\n  elements: retailUpgradeBlock.mvideoFromRetailUpgrade\n}, {\n  name: 'eldorado',\n  elements: retailUpgradeBlock.eldoradoFromRetailUpgrade\n}, {\n  name: 'mvideo',\n  elements: retailFooter.mvideoFromFooter\n}, {\n  name: 'eldorado',\n  elements: retailFooter.eldoradoFromFooter\n}]); // Инициализация классов на странице \"Сервис и Логистика\"\n\nnew _components_servece_and_logistic_logisticFirstScreenBlock__WEBPACK_IMPORTED_MODULE_31__.FirstScreenBlock('.logistic-stage');\nnew _components_servece_and_logistic_logisticVacanciesBlock__WEBPACK_IMPORTED_MODULE_32__.LogisticPageVacanciesBlock('.retail__position-list');\nnew _components_servece_and_logistic_logisticFlyout__WEBPACK_IMPORTED_MODULE_33__.LogisticPageFlyout('.flyout'); //-------------------------------------------------------------------------\n// Слушатели событий, установленные на Body\n\ndocument.body.addEventListener('click', function (event) {\n  headerComponent.closeSelect();\n  vacancyListingComponent.closeHeaderSelect();\n  itPageDirection.closeMobileSelect();\n\n  if (event.target.classList.contains('it-header__button') || event.target.classList.contains('intern__header-link')) {\n    event.preventDefault();\n    openApplicationForm();\n  }\n\n  if (event.target.classList.contains('create-future__button')) {\n    event.preventDefault();\n    smothScrollingToBlock(itHubPageGoalBlock.el, headerItPage);\n  }\n\n  if (event.target.classList.contains('goal__button')) {\n    event.preventDefault();\n    smothScrollingToBlock(itHubPageVacancy.el, headerItPage);\n  }\n}); //---------------------------------------------------------------------------------\n// Открыть анкету выбора вакансии\n\nfunction openApplicationForm() {\n  var form = document.querySelector('.form');\n  form.classList.add('form-active');\n  setTimeout(function () {\n    document.body.style.overflow = 'hidden';\n  }, 200);\n  setTimeout(function () {\n    form.firstElementChild.style.background = 'rgba(0, 0, 0, 0.8)';\n  }, 300);\n} //-----------------------------------------------------------------------------------\n// Скролл до блока\n\n\nfunction smothScrollingToBlock(block, header) {\n  var offset = 16;\n  var headerHeight = header.clientHeight + offset;\n\n  if (window.innerWidth <= 479) {\n    headerHeight = offset;\n  }\n\n  var topOffset = block.offsetTop - headerHeight;\n  var interval = setInterval(function () {\n    document.scrollingElement.scrollTop += 10;\n\n    if (document.scrollingElement.scrollTop >= topOffset) {\n      clearInterval(interval);\n    }\n  }, 1);\n} //-----------------------------------------------------------------------------------\n// Анимация переключателей (внутренние шарики) на странице IT\n\nfunction swichersAnimation(header, block, swichers) {\n  return function () {\n    var offset = 40;\n    var headerHeight = header.clientHeight;\n    var swichersCollection = swichers;\n\n    if (window.innerWidth <= 479) {\n      headerHeight = 0;\n    }\n\n    var topOffset = block.offsetTop - headerHeight;\n\n    if (window.scrollY >= topOffset - offset && window.scrollY <= topOffset + offset) {\n      setTimeout(function () {\n        swichersCollection[0].classList.toggle('intern__inside-circle-active');\n      }, 0);\n      setTimeout(function () {\n        swichersCollection[1].classList.toggle('intern__inside-circle-active');\n      }, 1000);\n      setTimeout(function () {\n        swichersCollection[2].classList.toggle('intern__inside-circle-active');\n      }, 2000);\n      setTimeout(function () {\n        swichersCollection[3].classList.toggle('intern__inside-circle-active');\n      }, 3000);\n    }\n  };\n} //----------------------------------------------------------------------------------\n// Отложенная загрузка изображений\n\nvar lazyImages = document.querySelectorAll('[data-src]');\n\nfunction isIntersecting(target) {\n  var docViewTop = window.pageYOffset;\n  var docViewBottom = docViewTop + window.innerHeight;\n  var elemTop = docViewTop + target.getBoundingClientRect().top;\n  var elemBottom = elemTop + target.height;\n  return elemTop <= docViewBottom && elemTop >= docViewTop || elemBottom <= docViewBottom && elemBottom >= docViewTop;\n}\n\nvar checkImages = function checkImages() {\n  lazyImages.forEach(function (target) {\n    if (isIntersecting(target) && target.parentNode.classList.contains('loading')) {\n      target.src = target.getAttribute('data-src');\n      target.parentNode.classList.remove('loading');\n      target.removeAttribute('data-src');\n    }\n  });\n};\n\nwindow.addEventListener('scroll', checkImages);\nwindow.addEventListener('DOMContentLoaded', checkImages);\nvar flyoutVacancy = document.querySelector('.vacancy');\n\nif (flyoutVacancy) {\n  flyoutVacancy.addEventListener('scroll', checkImages);\n} //----------------------------------------------------------------------------------\n\n//# sourceURL=webpack:///./js/index.js?");
