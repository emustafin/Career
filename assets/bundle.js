...
/***/ "./js/components/itHubPage/vacancyDirectLink.js":
/*!******************************************************!*\
  !*** ./js/components/itHubPage/vacancyDirectLink.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"VacancyDirectLink\": () => (/* binding */ VacancyDirectLink)\n/* harmony export */ });\n/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../index */ \"./js/index.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\nvar VacancyDirectLink = /*#__PURE__*/function () {\n  function VacancyDirectLink(el) {\n    _classCallCheck(this, VacancyDirectLink);\n\n    this.el = el;\n    if (this.el == null || this.el == undefined) return;\n    this.form = this.el.querySelector('.vacancy__form');\n    this.newsSlider;\n    this.init();\n    this.newsSliderInit();\n  }\n\n  _createClass(VacancyDirectLink, [{\n    key: \"init\",\n    value: function init() {\n      this.el.addEventListener('click', vacancyClickHandler.bind(this));\n    }\n  }, {\n    key: \"newsSliderInit\",\n    value: function newsSliderInit() {\n      if (this.el.clientWidth >= 671) {\n        this.newsSlider = new Swiper('.newsSlider', {\n          slidesPerView: 2.5,\n          spaceBetween: 16,\n          loop: true,\n          breakpoints: {\n            767: {\n              slidesPerView: 2.7,\n              spaceBetween: 30\n            },\n            1024: {\n              slidesPerView: 3.5,\n              spaceBetween: 30\n            },\n            1440: {\n              slidesPerView: 3.7,\n              spaceBetween: 40\n            },\n            1600: {\n              slidesPerView: 4,\n              spaceBetween: 40\n            }\n          }\n        });\n      }\n    }\n  }, {\n    key: \"resizeFlyout\",\n    value: function resizeFlyout() {\n      var _this = this;\n\n      window.addEventListener('resize', function () {\n        if (_this.flyout.clientWidth >= 671) {\n          _this.newsSliderInit();\n        }\n      });\n    }\n  }, {\n    key: \"copyLink\",\n    value: function () {\n      var _copyLink = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n        var link;\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                link = document.URL;\n                _context.next = 3;\n                return navigator.clipboard.writeText(link);\n\n              case 3:\n              case \"end\":\n                return _context.stop();\n            }\n          }\n        }, _callee);\n      }));\n\n      function copyLink() {\n        return _copyLink.apply(this, arguments);\n      }\n\n      return copyLink;\n    }()\n  }]);\n\n  return VacancyDirectLink;\n}();\n\nfunction vacancyClickHandler(event) {\n  if (event.target.classList.contains('direct-link__headline-link') || event.target.classList.contains('direct-link__vacancy-link')) {\n    (0,_index__WEBPACK_IMPORTED_MODULE_0__.smothScrollingToBlock)(this.form);\n  }\n\n  if (event.target.classList.contains('vacancy__news-btn-prev')) {\n    this.newsSlider.slidePrev();\n  }\n\n  if (event.target.classList.contains('vacancy__news-btn-next')) {\n    this.newsSlider.slideNext();\n  }\n\n  if (event.target.classList.contains('direct-link__header-head-copy')) {\n    event.preventDefault();\n    this.copyLink();\n  }\n}\n\n//# sourceURL=webpack:///./js/components/itHubPage/vacancyDirectLink.js?");
