...
<section class="text__post">
    <div class="section__text">
        <div><?php the_field( 'beforedescription' ); ?></div>
    </div>
    <img class="news__pic" src="<?php echo get_the_post_thumbnail_url( get_the_ID(), 'full' )?>" alt="">
    <div class="section__text">
        <div style="margin-bottom: 25px;"><?php the_content(); ?></div>
    </div>
